"""
Django settings for democrapp_api project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'fuyo8dh782grd2d82g0g72gdgb2ewyg8wg0207')
...
DATABASES = {
    'default': {
        ...
        'NAME': os.environ.get('DATABASE_DB', 'democrapp'),
